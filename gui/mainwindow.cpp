...
MainWindow::MainWindow(TexGenApplication* parent)
{
   ...
   project->addGenerator(new FillTextureGenerator());
   ...
   project->addGenerator(new LinesTextureGenerator());
   project->addGenerator(new GradientTextureGenerator());
   project->addGenerator(new StarTextureGenerator());
   project->addGenerator(new TransformTextureGenerator());
   project->addGenerator(new ModifyAlphaTextureGenerator());
   project->addGenerator(new BoxBlurTextureGenerator());
   project->addGenerator(new MirrorTextureGenerator());
   project->addGenerator(new GaussianBlurTextureGenerator());
   project->addGenerator(new SinePlasmaTextureGenerator());
   project->addGenerator(new NormalMapTextureGenerator());
   project->clear();
